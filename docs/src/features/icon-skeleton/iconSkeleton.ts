import type { IconCategoryChangeDetail } from '@shared/events/iconCategoryChange'
import type { IconSettingsChangeDetail } from '@shared/events/iconSettingsChange'
...
export class SvgSkeleton extends HTMLElement {
